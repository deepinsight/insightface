...
config.output = "/gpfs/gpfs0/k.fedyanin/space/models/scale/06_fine_tuning/sigm_32_lr_0.00003"
...
config.lr = 0.00003  # batch size is 512
config.scale_lr = 0.00003
