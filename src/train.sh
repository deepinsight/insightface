...
CUDA_VISIBLE_DEVICES='' python -u train_softmax.py --lr-steps=50000,100000,14000 --target=cfp_ff --verbose 2000 --data-dir $DATA_DIR --network "$NETWORK" --loss-type 5 --prefix "$PREFIX" --per-batch-size 32