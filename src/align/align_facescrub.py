...
def main(args):
    ...
    image_dir = os.path.join(args.input_dir, 'downloaded')
    ...
    with open(output_filename, "w") as text_file:
        ...
        for fimage in dataset:
            ...
            body = bname[(pb + 1):]
            if not body.isdigit():
                print("file passed ", fimage.image_path)
                continue
            img_id = int(body)
            key = (a, img_id)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--input-dir', type=str, help='Directory with unaligned images.', default="/home/lijc08/datasets/mega_facescrub/")
    parser.add_argument('--output-dir', type=str, help='Directory with aligned face thumbnails.', default="/home/lijc08/datasets/mega_facescrub/facescrub_aligned_112")
